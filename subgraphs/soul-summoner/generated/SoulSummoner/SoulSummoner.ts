...
export class SoulSummoner__getWithdrawableResult {
  value0: BigInt;
  value1: BigInt;
...
export class SoulSummoner__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SoulSummoner__userInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SoulSummoner extends ethereum.SmartContract {
  static bind(address: Address): SoulSummoner {
    return new SoulSummoner("SoulSummoner", address);
  }
  ...
  getWithdrawable(
    ...
    timeDelta: BigInt,
    amount: BigInt
  ): SoulSummoner__getWithdrawableResult {
    let result = super.call(
      "getWithdrawable",
    ...
    return new SoulSummoner__getWithdrawableResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getWithdrawable(
    ...
    timeDelta: BigInt,
    amount: BigInt
  ): ethereum.CallResult<SoulSummoner__getWithdrawableResult> {
    let result = super.tryCall(
      "getWithdrawable",
      "getWithdrawable(uint256,uint256,uint256):(uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SoulSummoner__getWithdrawableResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  poolInfo(param0: BigInt): SoulSummoner__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new SoulSummoner__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_poolInfo(
    param0: BigInt
  ): ethereum.CallResult<SoulSummoner__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SoulSummoner__poolInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  userInfo(param0: BigInt, param1: Address): SoulSummoner__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new SoulSummoner__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<SoulSummoner__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SoulSummoner__userInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
