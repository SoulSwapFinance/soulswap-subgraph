...
export class SeanceToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class SeanceToken extends ethereum.SmartContract {
  static bind(address: Address): SeanceToken {
    return new SeanceToken("SeanceToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): SeanceToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new SeanceToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<SeanceToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint256):(uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SeanceToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  operators(param0: BigInt): Address {
    let result = super.call("operators", "operators(uint256):(address)", [
  ...
  try_operators(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("operators", "operators(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class NewSoulCall extends ethereum.Call {
  get inputs(): NewSoulCall__Inputs {
    return new NewSoulCall__Inputs(this);
  }

  get outputs(): NewSoulCall__Outputs {
    return new NewSoulCall__Outputs(this);
  }
}

export class NewSoulCall__Inputs {
  _call: NewSoulCall;

  constructor(call: NewSoulCall) {
    this._call = call;
  }
...
export class NewSoulCall__Outputs {
  _call: NewSoulCall;
...
export class SafeSoulTransferCall extends ethereum.Call {
  get inputs(): SafeSoulTransferCall__Inputs {
    return new SafeSoulTransferCall__Inputs(this);
  }

  get outputs(): SafeSoulTransferCall__Outputs {
    return new SafeSoulTransferCall__Outputs(this);
  }
}

export class SafeSoulTransferCall__Inputs {
  _call: SafeSoulTransferCall;

  constructor(call: SafeSoulTransferCall) {
    this._call = call;
  }
...
export class SafeSoulTransferCall__Outputs {
  _call: SafeSoulTransferCall;
