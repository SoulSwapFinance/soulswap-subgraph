...
export function handleDistributionInitialization(event: Initialized): void {
  ...
  let factory = SwapStakingRewardsFactory.load(stakingRewardsFactoryAddress)
  if (factory === null) {
    factory = new SwapStakingRewardsFactory(stakingRewardsFactoryAddress)
...
export function handleDistributionCancelation(event: Canceled): void {
  // load factory (create if first distribution)
  let factory = SwapStakingRewardsFactory.load(getStakingRewardsFactoryAddress())
  if (factory === null) {
