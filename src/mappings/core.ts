...
export function handleSync(event: Sync): void {
  ...
  soulswap.totalLiquidityETH = soulswap.totalLiquidityETH.minus(pair.trackedReserveETH as BigDecimal)
  ...
  soulswap.totalLiquidityETH = soulswap.totalLiquidityETH.plus(trackedLiquidityETH)
  soulswap.totalLiquidityUSD = soulswap.totalLiquidityETH.times(bundle.ethPrice)
...
export function handleSwap(event: Swap): void {
  ...
  soulswap.totalVolumeETH = soulswap.totalVolumeETH.plus(trackedAmountETH)
  ...
  let soulswapDayData = updateSoulSwapDayData(event)
  let token0DayData = updateTokenDayData(token0 as Token, event)
  let token1DayData = updateTokenDayData(token1 as Token, event)

  // swap specific updating
  soulswapDayData.dailyVolumeUSD = soulswapDayData.dailyVolumeUSD.plus(trackedAmountUSD)
  soulswapDayData.dailyVolumeETH = soulswapDayData.dailyVolumeETH.plus(trackedAmountETH)
