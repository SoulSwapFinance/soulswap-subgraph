...
import { Pair, Bundle, Token, SoulSwapFactory, SoulSwapDayData, PairDayData, TokenDayData } from "../../generated/schema";
import { ONE_BI, ZERO_BD, ZERO_BI, FACTORY_ADDRESS } from "./utils";

export function updateSoulSwapDayData(event: ethereum.Event): SoulSwapDayData {
  ...
  if (soulSwapDayData === null) {
    soulSwapDayData = new SoulSwapDayData(dayID.toString());
  ...
  soulSwapDayData.totalLiquidityUSD = factory.totalLiquidityUSD;
  soulSwapDayData.totalLiquidityFTM = factory.totalLiquidityFTM;
  soulSwapDayData.totalTransactions = factory.totalTransactions;
  soulSwapDayData.save();

  return soulSwapDayData as SoulSwapDayData;
}
